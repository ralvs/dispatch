...
export function PushToggle() {
	...
	return (
		<button
			...
			className="rounded-md border border-line px-3 py-2 font-mono text-meta text-ink-3 transition-opacity hover:border-ink hover:text-ink active:opacity-70 disabled:opacity-50"
		>
